...
{fin = [(N 24),(N 72)], trans = 13},
{fin = [(N 62)], trans = 0},
{fin = [(N 39),(N 72)], trans = 15},
{fin = [(N 42)], trans = 0},
{fin = [(N 26),(N 72)], trans = 0},
{fin = [(N 34),(N 72)], trans = 18},
{fin = [(N 37)], trans = 0},
...
| 22 => (RPAR(yypos, yypos))
| 24 => (EQ(yypos, yypos))
| 26 => (SEMIC(yypos, yypos))
| 29 => (AND(yypos, yypos))
| 32 => (NOTEQ(yypos, yypos))
| 34 => (DPOINT(yypos, yypos))
| 37 => (DOUBLEPOINT(yypos, yypos))
| 39 => (LESS(yypos, yypos))
| 4 => (lex())
| 42 => (LESSEQ(yypos, yypos))
| 44 => (LBRACKET(yypos, yypos))
| 46 => (RBRACKET(yypos, yypos))
| 48 => (LCOL(yypos, yypos))
| 50 => (RCOL(yypos, yypos))
